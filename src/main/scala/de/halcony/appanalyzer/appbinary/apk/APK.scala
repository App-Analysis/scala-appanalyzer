...
case class APK(conf: Config) extends Analysis with LogSupport {
  ...
  * @return a list of class descriptors found in the APK
  */
  ...
  *
  * @param path the path to the APK file
  * @return the version code extracted from the APK
  */
  ...
  *
  * @param path the path to the APK file
  * @return the application ID extracted from the APK
  */
  ...
  /** retrieve the application ID from a MobileApp instance by analyzing its APK file
  *
  * @param app the MobileApp instance containing the APK path
  * @param default an optional default value (ignored in this implementation)
  * @return the application ID extracted from the APK
  */
