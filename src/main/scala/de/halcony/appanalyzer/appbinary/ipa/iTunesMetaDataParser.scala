...
object iTunesMetaDataParser {
  ...
  /** parse the key from the given XML element
    *
    * @param xml
    *   the XML element expected to have the label "key"
    * @return
    *   the text content of the key element
    */
  ...
  /** parse a dictionary from the given XML element
    *
    * @param xml
    *   the XML element expected to have the label "dict"
    * @return
    *   a MetaDict representing the parsed dictionary
    */
  ...
  /** parse an integer from the given XML element
    *
    * @param xml
    *   the XML element expected to have the label "integer"
    * @return
    *   a MetaInteger representing the parsed integer value
    */
  ...
  /** parse a string from the given XML element
    *
    * @param xml
    *   the XML element expected to have the label "string"
    * @return
    *   a MetaString representing the parsed string value
    */
  ...
  /** parse a boolean value from the given XML element
    *
    * @param xml
    *   the XML element expected to have the label "true" or "false"
    * @return
    *   a MetaBoolean representing the parsed boolean value
    */
  ...
  /** parse an unknown XML element into a MetaUnknown
    *
    * @param elem
    *   the XML element with an unrecognized label
    * @return
    *   a MetaUnknown containing the element's label and text content
    */
  ...
  /** parse the given XML element into an iTunesMetaDataElement
    ...
    * @return
    *   an iTunesMetaDataElement representing the parsed content of the XML
    *   element
    */
