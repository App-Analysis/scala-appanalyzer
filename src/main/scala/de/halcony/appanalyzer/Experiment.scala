...
object Experiment extends LogSupport {
  ...
  /** macro ensures that any error not caught inside will be stored with the
    * running experiment
    *
    * this is a last line of catching errors, will throw a fatal error as any
  ...
  /** inserts a new experiment into the database and stores the corresponding
    * object
    *
    * @param description
